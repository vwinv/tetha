      ...
      <div class="relative mx-auto w-full max-w-[1100px] px-2 sm:px-3 lg:px-4" id="who">
        ...
        <div class="grid gap-5 rounded-3xl overflow-hidden bg-white shadow-2xl lg:grid-cols-6">
          <div class="relative order-last h-[210px] lg:order-first lg:h-full lg:col-span-2">
            <img :src="founderImage" :alt="$t('founder.title')" class="object-cover w-full h-full" />
          </div>
      ...
      <div class="mx-auto w-full max-w-[1000px] px-2 sm:px-3 lg:px-4">
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <div
            ...
            :key="service.title"
            class="flex min-h-[210px] flex-col overflow-hidden rounded-3xl bg-white shadow-xl transition hover:-translate-y-2 hover:shadow-2xl"
          >
    ...
    <section class="py-10">
      <div class="mx-auto w-full max-w-[1100px] px-2 sm:px-3 lg:px-4 text-center">
        ...
        <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center">
          ...
          >
            <img :src="logo" :alt="$t('partners.title')" class="max-h-16 w-auto object-contain" />
          </div>
        </div>
      </div>
    </section>
...
import founderImage from '@/assets/images/fondatrice.png'
